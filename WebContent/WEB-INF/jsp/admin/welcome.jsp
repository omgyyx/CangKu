		...
		<div class="row">
			<div class="col-md-3 col-sm-6 col-xs-12">
				<div class="info-box bg-info">
					...
					<div class="info-box-content">
						<span class="info-box-text">文章总量</span> <span
							class="info-box-number">320 <small>篇</small>
						</span>
					</div>
				</div>
			</div>
			<div class="col-md-3 col-sm-6 col-xs-12">
				<div class="info-box bg-primary">
					...
					<div class="info-box-content">
						<span class="info-box-text">用户总量</span> <span
							class="info-box-number">90 <small>个</small>
						</span>
					</div>
				</div>
			</div>
			<div class="col-md-3 col-sm-6 col-xs-12">
				<div class="info-box bg-warning">
					...
					<div class="info-box-content">
						<span class="info-box-text">栏目总量</span> <span
							class="info-box-number">8 <small>个</small>
						</span>
					</div>
				</div>
			</div>
			<div class="col-md-3 col-sm-6 col-xs-12">
				<div class="info-box bg-danger">
					...
					<div class="info-box-content">
						<span class="info-box-text">PV总量</span> <span
							class="info-box-number">18953 <small>次</small>
						</span>
					</div>
				</div>
			</div>
							...
							<tr>
								...
								<td><a target="_blank"
									href="http://shang.qq.com/wpa/qunwpa?idkey=65deab2f8ea1e9d2445c3262d133da48fe9de53bd90a3146c3f7bb6fb9d63ead"><img
										...
										alt="zui-admin后台模板交流" title="zui-admin后台模板交流"></a></td>
							</tr>
						</table>
					</div>
				</div>
