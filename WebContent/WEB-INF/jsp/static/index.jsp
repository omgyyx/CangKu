...
<link href="${path }/static/css/index_style.css" rel="stylesheet"
	type="text/css">
...
<body>
	...
	<%-- 
    ${path }/AdminServlet?op=tologin
    op代表相应的功能，（增删改查  op=del op=add op=update op=all ）
    
     --%>
	<div id="navgation" class="navgation navgation_close">
		<ul class="point" id="menus">
			<li><a href='#'>首页</a></li>
		...
		<div class="fp-tablecell">
			<div class="page2">
				<div class="warp-box">
					...
					<div class="layui-row">
						<div
							class="layui-col-xs12 layui-col-sm4 layui-col-md4  wow fadeInUp"
							style="padding: 0 10px">
							<div class="single-news">
								<div class="news-head">
									<img src="${path }/static/image/1.jpg"> <a href="#"
										class="link"><i class="fa fa-link"></i></a>
								</div>
						...
						<div
							class="layui-col-xs12 layui-col-sm4 layui-col-md4  wow fadeInUp"
							data-wow-delay=".2s" style="padding: 0 10px">
							<div class="single-news">
								<div class="news-head">
									<img src="${path }/static/image/1.jpg"> <a href="#"
										class="link"><i class="fa fa-link"></i></a>
						...
						<div
							class="layui-col-xs12 layui-col-sm4 layui-col-md4  wow fadeInUp"
							data-wow-delay=".4s" style="padding: 0 10px">
							<div class="single-news">
								<div class="news-head">
									<img src="${path }/static/image/1.jpg"> <a href="#"
										class="link"><i class="fa fa-link"></i></a>
					...
					<div class="about">
						<div class="inner">
							...
							<p class="wow fadeInRight">
								爱好游戏，动漫。闲来无事喜欢在一些不健康的场所虚度光阴，撸起代码就会废寝忘食。</p>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="single-widget">
							...
							<ul class="social-icon">
								...
								<li class="active"><a href="#"><i
										class="fa fa-comments"></i>留言</a></li>
								<li class="active"><a href="#"><i class="fa fa-share"></i>资源</a></li>
								<li class="active"><a href="#"><i
										class="fa fa-snowflake-o"></i>日记</a></li>
			...
			<div class="container">
				<div class="layui-row">
					<div
						...
						<p>Copyright &copy; 2018-2018 燕十三 All Rights Reserved V.3.1.3
							蜀ICP备18008600号</p>
					</div>
				</div>
			</div>
	...
	<script type="text/javascript">
		$(function() {
			...
			$.ajax({
				type : "GET",
				url : "${path}/api/nav/all.action",
				success : function(msg) {
					//console.log( msg);
					 $.each(msg,function(index,obj){
						
					   lis+="<li><a href='${path}"+obj.url+"'>"+obj.name+"</a></li>"
					})
